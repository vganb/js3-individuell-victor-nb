...
const DashboardPage = () => {
  ...
  const handleCancelBooking = async (eventId) => {
    try {
      ...
      await axios.delete(`http://localhost:3000/api/avbookning`, {
        data: { email: attendeeEmail, eventId },
      });
  ...
  return (
    <div className="flex flex-col">
      <PageHeadline> my Booked Events</PageHeadline>

      {filterEvents.length === 0 ? (
        <div className="flex justify-center mt-20 text-3xl font-bold underline">You have no booked events</div>
      ) : (
